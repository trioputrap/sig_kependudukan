...
<body class="fix-header card-no-border">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Form Tambah Kartu Keluarga</h4>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal form-bordered">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            <label class="control-label text-right col-md-3">Nomor Kartu Keluarga</label>
                                            <div class="col-md-9">
                                                <input name="no_kk" type="text" placeholder="2142 4215 5213" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label text-right col-md-3">Alamat</label>
                                            <div class="col-md-9">
                                                <input name="alamat" type="text" placeholder="Jl. Surapati No 23 Denpasar" class="form-control">    
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label text-right col-md-3">Provinsi</label>
                                            <div class="col-md-9">
                                                <select name="provinsi_id" id="slc_prov" class="form-control custom-select">
                                                    @foreach($provinsis as $provinsi)
                                                    <option value="{{$provinsi->id}}">{{$provinsi->nama}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="kabupaten_id" id="slc_kab" class="form-control custom-select" disabled>
                                                    <option value="">-PILIH PROVINSI TERLEBIH DAHULU-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="kecamatan_id" id="slc_kec" class="form-control custom-select" disabled>
                                                    <option value="">-PILIH KABUPATEN TERLEBIH DAHULU-</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select name="desa_id" id="slc_desa" class="form-control custom-select" disabled>
                                                    <option value="">-PILIH KECAMATAN TERLEBIH DAHULU-</option>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script>
        function ajax_daerah(daerah, id, select_element, master){
            $.ajax({
                url: "sigpenduk.herokuapp.com/api/"+ id +"/"+ daerah,
                type: "GET",
                crossDomain: true,
                dataType: "json",                
                processData: false,
